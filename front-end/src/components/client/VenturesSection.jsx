...
export default function VenturesSection() {
 ...
 const SERVER_URL = import.meta.env.VITE_SERVER_URL;
  ...
  ? projects.filter(p => p.status === 'Up-Coming' || p.status === 'On-Going')
  : [];
          ...
          <div className="relative h-64">
            {venture.mainImage && ( // Check if venture.mainImage is truthy (not null, not undefined, not an empty string)
              <img
                ...
                // Optional: Add an error handler to catch cases where the image fails to load after this check
                onError={(e) => {
            ...
            {/* Optional: Show a placeholder if mainImage is null */}
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap items-center gap-4 mb-4">
                  <div className="flex items-center">
                    ...
                    <p className="text-gray-700">Per Sq.ft Price ₹{Math.round(venture.pricePerSquareFoot)}</p>
                  </div>
                </div>
